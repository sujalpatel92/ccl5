...
curl_setopt_array($curl, array(
	...
	CURLOPT_URL => '35.162.32.72:8000/registerpi/get_pi_confirmation?pi_id='.$piid.'|'.$_SESSION['email'],
...
$sql = "insert into piinfo (id,location,piid,status) VALUES ($id,'$location','$piid','$status')";
